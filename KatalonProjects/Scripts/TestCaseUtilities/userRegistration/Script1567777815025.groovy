...
for (int row = 1; row <= noOfContacts; row++) {
    ...
    WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(WebUiCommonHelper.findWebElement(findTestObject('Object Repository/virualShowRSVPOR/Page_Show microsite/button_Continue'), 
                30)))
    ...
    WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(WebUiCommonHelper.findWebElement(findTestObject('User_Registration/input_fname_div'), 
                30)))
    ...
    WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(WebUiCommonHelper.findWebElement(findTestObject('User_Registration/input_lname_div'), 
                30)))
    ...
    WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(WebUiCommonHelper.findWebElement(findTestObject('Object Repository/User_Registration/input_pass_div'), 
                30)))
    ...
    WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(WebUiCommonHelper.findWebElement(findTestObject('Object Repository/User_Registration/input_confirm-pass_div'), 
                30)))
    ...
    List<WebElement> emailAlreadyLogin = WebUiCommonHelper.findWebElements(findTestObject('Object Repository/User_Registration/span_inbox_verify_already_login'), 
        5)

    if (emailAlreadyLogin.size() < 1) {
        ...
        WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(WebUiCommonHelper.findWebElement(findTestObject('Object Repository/User_Registration/Roundcube_Webmail/input_submit'), 
                    30))) //WebUI.click(findTestObject('Object Repository/User_Registration/Roundcube_Webmail/input_submit'))
    }
    ...
    WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(WebUiCommonHelper.findWebElement(findTestObject('Object Repository/User_Registration/input_verify_code_div'), 
                30)))
    ...
    //WebUI.click(findTestObject('Object Repository/User_Registration/button_submit'))
    WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(WebUiCommonHelper.findWebElement(findTestObject('Object Repository/User_Registration/verify_text_welcome'), 
                30)))
    ...
    if (completeMyPlrofileLater.size() > 0) {
        WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(WebUiCommonHelper.findWebElement(findTestObject('Object Repository/User_Registration/a_I_will_complete_my_profile_later'), 
                    30)))
    }
    
    WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(WebUiCommonHelper.findWebElement(findTestObject('Object Repository/User_Registration/a_profile_dropdown'), 
                30)))

    //WebUI.click(findTestObject('Object Repository/User_Registration/a_profile_dropdown'))
    WebUI.delay(1)

    WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(WebUiCommonHelper.findWebElement(findTestObject('Object Repository/User_Registration/a_sign_out'), 
                30)))

    //WebUI.click(findTestObject('Object Repository/User_Registration/a_sign_out'))
    List<WebElement> signoutButton = WebUiCommonHelper.findWebElements(findTestObject('Object Repository/User_Registration/a_logout'), 
        5)

    if (signoutButton.size() > 0) {
        WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(WebUiCommonHelper.findWebElement(findTestObject('Object Repository/User_Registration/a_logout'), 
                    30)))
    }
    
    signoutButton = WebUiCommonHelper.findWebElements(findTestObject('Object Repository/User_Registration/a_signout'), 5)

    if (signoutButton.size() > 0) {
        WebUI.executeJavaScript('arguments[0].click()', Arrays.asList(WebUiCommonHelper.findWebElement(findTestObject('Object Repository/User_Registration/a_signout'), 
                    30)))
    } //WebUI.executeJavaScript("arguments[0].click()", Arrays.asList(WebUiCommonHelper.findWebElement(findTestObject('Object Repository/User_Registration/a_logout'),30)))
    //WebUI.executeJavaScript("arguments[0].click()", Arrays.asList(WebUiCommonHelper.findWebElement(findTestObject('Object Repository/User_Registration/a_signout'),30)))
    //WebUI.closeWindowIndex(currentTab + 1)
}