...
//WebUI.delay(5)
WebUI.click(findTestObject('Object Repository/virualShowRSVPOR/Page_cabi Create Show - Time and Place/check_Physical_Show'))
...
WebUI.delay(2)
WebUI.click(findTestObject('virualShowRSVPOR/Page_cabi Create Show - Time and Place/check_show_address_same_as_hostess'))
WebUI.delay(2)
WebUI.click(findTestObject('Object Repository/virualShowRSVPOR/Page_cabi Create Show - Time and Place/check_shipping_address_same_as_location'))
WebUI.delay(2)
...
executor.executeScript('arguments[0].click();', WebUiCommonHelper.findWebElement(findTestObject('Object Repository/virualShowRSVPOR/Page_cabi Orders/a_My Profile'), 5))
