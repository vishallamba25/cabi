...
/********************Validation for infocus************/

String SD_FocusPersonRole = WebUI.getText(findTestObject('Object Repository/virualShowRSVPOR/dashboard/SD_infocus_activeRadioType'))
String SD_FocusPersonName = WebUI.getText(findTestObject('Object Repository/virualShowRSVPOR/dashboard/SD_infocus_activeRadioName'))


String ExpectedInfocus = SD_FocusPersonRole+":"+""+SD_FocusPersonName
